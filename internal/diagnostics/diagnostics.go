...
func (o *Orchestrator) runBuild(_ context.Context) ([]Diagnostic, error)     { return nil, nil }
func (o *Orchestrator) runOutdated(_ context.Context) ([]Diagnostic, error)  { return nil, nil }
func (o *Orchestrator) runSecurity(_ context.Context) ([]Diagnostic, error)  { return nil, nil }
func (o *Orchestrator) runModernize(_ context.Context) ([]Diagnostic, error) { return nil, nil }
